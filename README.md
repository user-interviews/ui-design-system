...
`yarn lint`
_Runs TypeScript, Oxlint, and Stylelint to report on any code and style violations._

`yarn lint:js`
_Runs TypeScript type checking and Oxlint on JavaScript/TypeScript files._

`yarn lint:js:fix`
_Runs Oxlint with safe autofixes on JavaScript/TypeScript files._
...
`yarn format`
_Formats supported files with Oxfmt, including import sorting._

`yarn format:check`
_Checks whether supported files are formatted according to Oxfmt._
