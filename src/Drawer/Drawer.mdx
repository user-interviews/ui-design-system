...
* **Drawer**
    ...
    * If you do need to do something truly custom, Drawer can be used as a general purpose container for your own components
...
There are three `size` options, `small` (default), `medium` and `large`
...
<Canvas>
  <Story id="components-drawer--medium" />
</Canvas>

### Large

<Canvas>
  <Story id="components-drawer--large" />
</Canvas>
...
<Canvas>
  <Story id="components-drawer--orientation" />
</Canvas>
...
<Canvas>
  <Story id="components-drawer--expandable" />
</Canvas>

### Additional Actions

If additional components are required to be included, pass them as children to the `DrawerFooter`. This example also doesn't have a title or a border on the header.

<Canvas>
  <Story id="components-drawer--additional-actions" />
</Canvas>
...
<Canvas>
  <Story id="components-drawer--empty" />
</Canvas>
