...
<h4>
  Drawers are container elements which slide in and sit on top of an application's main window. To
  return to the main interface users must click outside of the drawer, click an action within the
  drawer such as a close or cancel button, or press the escape key.
</h4>
