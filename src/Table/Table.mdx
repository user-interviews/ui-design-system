...
<Canvas>
  <Story id="components-table--table-on-stuff" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-dnd" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-fixed-column-widths" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-on-card" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-on-card-no-padding" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-single-action-column" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-multiple-action-column" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-sticky-column-and-header" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-multiple-sticky-columns-and-header" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-multiple-select" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-multiple-select-and-multiple-sticky-columns-and-header" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-sorting" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-cell-right-alignment" />
</Canvas>
...
<Canvas>
  <Story id="components-table--table-with-compact-option" />
</Canvas>
