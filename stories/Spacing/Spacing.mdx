...
<h4>
  Spacing is a key component of a design system that defines the consistent and intentional distance
  between elements. It ensures visual balance and enhances usability by providing a clear hierarchy
  of content.
</h4>
