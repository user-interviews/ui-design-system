...
<div style={{ width: '50%', margin: '0 auto', textAlign: 'center' }}>
  ...
  <a
    type="button"
    style={{
      background: colors.UX_NEUTRAL_300,
      borderRadius: '60px',
      fontSize: '14px',
      fontWeight: 'bold',
      padding: '10px 20px',
      margin: '10px',
      border: '0',
      color: colors.UX_GRAY_700,
    }}
    href="https://www.figma.com/file/471iS3QrpPtXZpS1xbsJ20/Components"
    rel="noopener noreferrer"
    target="_blank"
  >
    <img alt="" src={FigmaLogo} style={{paddingRight: '0.25rem' }} />
    Figma Library
  </a>
  <a
    type="button"
    ...
    target="_blank"
  >
      <img alt="" src={GithubLogo} style={{paddingRight: '0.25rem' }}/>
      Github Repo
  </a>
</div>
